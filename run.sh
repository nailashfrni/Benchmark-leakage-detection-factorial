python data_process.py  --data_dir data --filename peft_dataset.json --save_dir data
python Benchmark-leakage-detection-factorial/inference_logprobs.py --model_dir unsloth/Qwen2.5-0.5B-Instruct --permutations_data_dir /kaggle/working/Benchmark-leakage-detection-factorial/data/permutations_data_clean_peft_dataset.json --save_dir data --fine_tune_type cpt --checkpoint_epoch 1
